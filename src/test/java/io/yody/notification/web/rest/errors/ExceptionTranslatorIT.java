package io.yody.notification.web.rest.errors;
...
class ExceptionTranslatorIT {
    ...
    void testConcurrencyFailure() throws Exception {
        mockMvc
            ...
            .andExpect(jsonPath("$.message").value(NtsErrorConstants.ERR_CONCURRENCY_FAILURE));
    }
    ...
    void testMethodArgumentNotValid() throws Exception {
        mockMvc
            ...
            .andExpect(content().contentType(MediaType.APPLICATION_PROBLEM_JSON))
            .andExpect(jsonPath("$.message").value(NtsErrorConstants.ERR_VALIDATION))
